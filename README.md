...
I'm a passionate software developer with expertise in Java/Kotlin, C#, Spring, PL/SQL, and SQL. Welcome to my GitHub profile, where I share my projects and experiments in software development.
...
![Kotlin](https://img.shields.io/badge/kotlin-%23ED8B00.svg)
...
- **Programming Languages**: Java, Kotlin, C#, Python, PL/SQL, SQL
- **Frameworks & Libraries**: Spring Framework, Spring Boot
- **Databases**: MySQL, Oracle
- **Tools & Technologies**: Git, Maven, Jenkins, JUnit, Docker, Kubernetis, Kafka, RabbitMQ
